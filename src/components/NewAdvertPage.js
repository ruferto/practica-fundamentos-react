...
const NewAdvertPage = () => {
    ...
    return <div style={{display: 'flex', justifyContent:'center', alignItems:'center'}}> <div className='new-ad-container'>
        ...
        <div className='new-ad-wrapper'>
            ...
            <div>
                ...
                <div style={{fontSize:'1.2rem', display:'flex', flexDirection:'row', padding:7, justifyContent:'center'}}>
                    <label style={{fontSize:14, marginRight:20}}>Type</label>
                    <div style={{marginRight:20, fontFamily:'SanchezFont', fontSize:25}}><input id='sale' name='sale' type='radio' value={true} onChange={handleChange} defaultChecked /><label> Sale</label></div>
                    <div style={{marginRight:20, fontFamily:'SanchezFont', fontSize:25}}><input id='sale' name='sale' type='radio' value={false} onChange={handleChange}/><label> Buy</label></div>
                </div>
            <div>
                <label htmlFor='tags'>Tags</label>
                <SelectTag handleChange={handleChange} selected={tags} setTagsForNew={setTags} width={500}/>
            </div>
            <div style={{marginTop:20, marginBottom:20, marginRight:'auto', marginLeft:'auto'}}>
