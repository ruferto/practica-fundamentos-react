...
const PriceRange = ({initialRange, onChange}) => {
  ...
  return <div>
    <div style={wrapperStyle}>
      <p style={{color: 'gray', textAlign:'center', paddingBottom:10}}>Price range <span style={{color:'black',fontSize:18}}>{valuesState[0]} €</span> and <span style={{color:'black',fontSize:18}}>{valuesState[1]} €</span></p>
      <Range 
